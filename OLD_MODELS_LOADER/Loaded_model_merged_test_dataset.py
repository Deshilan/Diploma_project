...
old_model =  keras.models.load_model(r'C:\python\PROJEKT_DYPLOMOWY\FINAL_WEIGHTS\Final_weights_CNN_100epochs\my_model.keras')

weights = old_model.get_weights()
model.set_weights(weights)


directory_es_0 = r'C:\python\PROJEKT_DYPLOMOWY\Part_images\FULL_TEST_DATASET\0'
directory_es_1 = r'C:\python\PROJEKT_DYPLOMOWY\Part_images\FULL_TEST_DATASET\1'
